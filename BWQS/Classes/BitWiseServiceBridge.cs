...
namespace System.Linq.Dynamic.BitWise.Service
{
    ...
    public class BitWiseServiceBridge
    {
        ...
        public string Q(string bwqExpr, string serialResult, string serialType)
        {
            return Query(bwqExpr, serialResult, serialType);
        }

        public string W(string bwqExpr, string serialResult, string serialType)
        {
            return Where(bwqExpr, serialResult, serialType);
        }

        public string O(string bwqExpr, string serialResult, string serialType)
        {
            return OrderBy(bwqExpr, serialResult, serialType);
        }

        public string OD(string bwqExpr, string serialResult, string serialType)
        {
            return OrderByDescending(bwqExpr, serialResult, serialType);
        }

        public string G(string grpExpr, string _byExpr, string serialResult, string serialType)
        {
            return GroupBy(grpExpr, _byExpr, serialResult, serialType);
        }
